...
Дедлайн: якщо в тексті є згадка часу («сьогодні», «завтра», «післязавтра», «до пʼятниці», «наступного тижня», «через 3 дні», «15 числа»), обчисли конкретну дату відносно сьогоднішньої і поверни її у форматі YYYY-MM-DD. Якщо дати не згадано — поверни deadline = null. Не вигадуй дедлайнів.
